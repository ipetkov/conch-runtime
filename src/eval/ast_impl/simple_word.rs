    ...
    E::VarName: Borrow<String>,
{
    ...
    fn eval_with_config(self, env: &E, cfg: WordEvalConfig) -> Self::EvalFuture {
        ...
        let done = match self {
            Literal(s) | Escaped(s) => Fields::Single(s),
    ...
    E::VarName: Borrow<String>,
{
    ...
    fn eval_with_config(self, env: &E, cfg: WordEvalConfig) -> Self::EvalFuture {
        ...
        let done = match *self {
            Literal(ref s) | Escaped(ref s) => Fields::Single(s.clone()),
    ...
    E::VarName: Borrow<String>,
{
    ...
    match *simple {
        ...
        Literal(_) | Escaped(_) | Param(_) | Subst(_) => {
            panic!("not a constant variant, cannot eval this way!")
        }
    }
}
